...
const struct InvestigationPresentData gInvestigationPresentData_2_4[22] = {
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xA1,
		.wrongEvidenceSection = 0xA2,
	},
	{
		.roomId = 0x7,
		.evidenceId = 0x35,
	...
	},
	{
		...
		.personId = PERSON_ANIM_WENDY_OLDBAG,
		.end = 0x0,
		.evidenceCommentSection = 0xB2,
		.wrongEvidenceSection = 0xB3,
	},
	{
		.roomId = 0x8,
		.evidenceId = 0x43,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xDB,
		.wrongEvidenceSection = 0xDE,
	},
	{
		.roomId = 0x9,
		.evidenceId = 0x35,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xF5,
		.wrongEvidenceSection = 0xF6,
	},
	{
		.roomId = 0xFF,
		.evidenceId = 0xFF,
