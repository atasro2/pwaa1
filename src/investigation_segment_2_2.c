...
const struct InvestigationPresentData gInvestigationPresentData_2_2[36] = {
    {
        ...
        .end = 0x0,
        .evidenceCommentSection = 0x88,
        .wrongEvidenceSection = 0x8C,
    },
    {
        .roomId = 0x6,
        .evidenceId = 0x33,
    ...
    },
    {
        ...
        .end = 0x0,
        .evidenceCommentSection = 0x98,
        .wrongEvidenceSection = 0x9B,
    },
    {
        .roomId = 0x2,
        .evidenceId = 0x38,
    ...
    },
    {
        ...
        .end = 0x0,
        .evidenceCommentSection = 0xAA,
        .wrongEvidenceSection = 0xAD,
    },
    {
        .roomId = 0x7,
        .evidenceId = 0x35,
    ...
    },
    {
        ...
        .end = 0x0,
        .evidenceCommentSection = 0xB9,
        .wrongEvidenceSection = 0xBE,
    },
    {
        .roomId = 0x7,
        .evidenceId = 0x35,
    ...
    },
    {
        ...
        .end = 0x0,
        .evidenceCommentSection = 0xD3,
        .wrongEvidenceSection = 0xD3,
    },
    {
        .roomId = 0x9,
        .evidenceId = 0x34,
    ...
    },
    {
        ...
        .personId = PERSON_ANIM_CODY_HACKINS,
        .end = 0x0,
        .evidenceCommentSection = 0xFD,
        .wrongEvidenceSection = 0x102,
    },
    {
        .roomId = 0x9,
        .evidenceId = 0x3F,
    ...
    },
    {
        ...
        .end = 0x0,
        .evidenceCommentSection = 0x141,
        .wrongEvidenceSection = 0x142,
    },
    {
        .roomId = 0xD,
        .evidenceId = 0x3E,
        .personId = PERSON_ANIM_PENNY_NICHOLS,
        .end = 0x0,
        .evidenceCommentSection = 0x14A,
        .wrongEvidenceSection = 0x149,
    },
    {
        .roomId = 0xFF,
        .evidenceId = 0xFF,
