...
const struct InvestigationPresentData gInvestigationPresentData_1_0[17] = {
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xA8,
		.wrongEvidenceSection = 0xA7,
	},
	{
		.roomId = 0x0,
		.evidenceId = 0x1A,
	...
	},
	{
		...
		.personId = PERSON_ANIM_MAYA,
		.end = 0x0,
		.evidenceCommentSection = 0xD2,
		.wrongEvidenceSection = 0xD1,
	},
	{
		.roomId = 0x2,
		.evidenceId = 0x1C,
