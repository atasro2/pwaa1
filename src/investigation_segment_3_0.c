...
const struct InvestigationPresentData gInvestigationPresentData_3_0[25] = {
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0x97,
		.wrongEvidenceSection = 0x98,
	},
	{
		.roomId = 0x2,
		.evidenceId = 0x52,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xB1,
		.wrongEvidenceSection = 0xB2,
	},
	{
		.roomId = 0x11,
		.evidenceId = 0x17,
		...
		.end = 0x0,
		.evidenceCommentSection = 0xBD,
		.wrongEvidenceSection = 0xC1,
	},
	{
		.roomId = 0x11,
		.evidenceId = 0x52,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xCD,
		.wrongEvidenceSection = 0xD0,
	},
	{
		.roomId = 0x12,
		.evidenceId = 0x55,
	...
	},
	{
		...
		.personId = PERSON_ANIM_GUMSHOE,
		.end = 0x0,
		.evidenceCommentSection = 0xDC,
		.wrongEvidenceSection = 0xDD,
	},
	{
		.roomId = 0xE,
		.evidenceId = 0x5B,
		.personId = PERSON_ANIM_GUMSHOE,
		.end = 0x0,
		.evidenceCommentSection = 0xE3,
		.wrongEvidenceSection = 0xE4,
	},
	{
		.roomId = 0x3,
		.evidenceId = 0x17,
		...
		.end = 0x0,
		.evidenceCommentSection = 0xF0,
		.wrongEvidenceSection = 0xF5,
	},
	{
		.roomId = 0x3,
		.evidenceId = 0x52,
