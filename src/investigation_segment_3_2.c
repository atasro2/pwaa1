...
const struct InvestigationPresentData gInvestigationPresentData_3_2[45] = {
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0x89,
		.wrongEvidenceSection = 0x89,
	},
	{
		.roomId = 0x2,
		.evidenceId = 0x17,
		.personId = PERSON_ANIM_MAYA,
		.end = 0x0,
		.evidenceCommentSection = 0x8F,
		.wrongEvidenceSection = 0x95,
	},
	{
		.roomId = 0x2,
		.evidenceId = 0x57,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xA2,
		.wrongEvidenceSection = 0xDB,
	},
	{
		.roomId = 0x10,
		.evidenceId = 0x57,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xAB,
		.wrongEvidenceSection = 0xB6,
	},
	{
		.roomId = 0x11,
		.evidenceId = 0x5A,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xC1,
		.wrongEvidenceSection = 0xC8,
	},
	{
		.roomId = 0x12,
		.evidenceId = 0x55,
	...
	},
	{
		...
		.end = 0x0,
		.evidenceCommentSection = 0xFF,
		.wrongEvidenceSection = 0xFE,
	},
	{
		.roomId = 0x14,
		.evidenceId = 0x5A,
	...
	},
	{
		...
		.personId = PERSON_ANIM_MAYA,
		.end = 0x0,
		.evidenceCommentSection = 0x10D,
		.wrongEvidenceSection = 0x10D,
	},
	{
		.roomId = 0xFF,
		.evidenceId = 0xFF,
		.personId = 0xFF,
		.end = 0xFF,
		.evidenceCommentSection = 0xFFFF,
		.wrongEvidenceSection = 0xFFFF,
	},
};
