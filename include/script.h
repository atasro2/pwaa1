...
struct ScriptContext
{
    ...
    /* +0x2F */ u8 unused2F; // unity AA4: moji? // unused
    /* +0x30 */ u8 unused30; // unity AA4: houtei_page? // unused
    /* +0x31 */ u8 unused31; // unity AA4: plate_set_flag? // unused
    ...
    /* +0x3A */ u8 unused3A; // unity AA4: add_y, used but does nothing
